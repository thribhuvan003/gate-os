  ...
  return (
    <main className="relative grid min-h-dvh overflow-hidden bg-[var(--ink)] px-5 text-[var(--background)]">
      ...
      <div className="relative m-auto max-w-4xl text-center">
        ...
        <Link className={`mt-10 inline-flex min-h-12 items-center gap-2 rounded-full bg-[var(--accent)] px-6 font-bold text-white transition duration-500 ${ready ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"}`} href={nextPath}>
