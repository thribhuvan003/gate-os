  ...
  return (
    <main id="main-content" className="landing min-h-screen overflow-hidden px-4 pb-16 sm:px-6 lg:px-10">
      ...
      <div className="mx-auto flex max-w-[1480px] flex-wrap items-center justify-center gap-x-3 gap-y-1 pt-4 text-center text-xs text-[var(--muted)] sm:pt-5">
        <span className="mono-label text-[var(--accent)]">Private beta</span>
        ...
        <div className="grid gap-8 border-y border-[var(--line)] py-10 lg:grid-cols-[.8fr_1.2fr] lg:py-16">
          <div>
            ...
            <p className="mt-4 max-w-md leading-7 text-[var(--muted)]">
              A small, serious first cohort. Your invite unlocks a private workspace that stays yours — never a feed, never a leaderboard.
            </p>
          </div>
          <div>
        ...
        <div className="surface-card relative overflow-hidden p-8 sm:p-14">
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.4fr_1fr]">
            <div>
              ...
              <p className="mt-5 max-w-xl leading-7 text-[var(--muted)]">Enter your invitation code and start your first focus block in under a minute. Your workspace begins empty and records only your work.</p>
            </div>
            <div className="flex flex-wrap gap-3 lg:justify-end">
              <Link className="primary-button" href="#invite">Enter invite code <ArrowRight aria-hidden="true" size={17} /></Link>
      ...
      <footer className="mx-auto flex max-w-[1480px] flex-wrap items-center justify-between gap-4 border-t border-[var(--line)] py-8 text-sm text-[var(--muted)]">
        ...
        <nav className="flex items-center gap-5" aria-label="Footer">
          ...
          <a className="transition hover:text-[var(--accent)]" href="#invite">
            Request access
          </a>
